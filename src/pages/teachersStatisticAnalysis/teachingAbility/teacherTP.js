...
function TeacherTP(props, ref) {
      ...
      tooltip: {
        ...
        formatter: (params) => {
          ...
          return `<div  class="t-tooltip">
            ...
            data[3]
          }人</span></p><p class='msg msg-2'>未参与制作人数<span>${
            data[2] - data[3]
          }人</span></p></div>
            `;
        },
  ...
  return (
    <div className={`teacher-bar TeacherTP ${className ? className : ""} `}>
      <div className="ter-left">
        <p className="tb-tip">
          {productMsg && productMsg.title ? productMsg.title : ""}
          总体电子教案制作<span className="tb-tip-2">{TPCount}</span>
          份，人均制作
          <span className="tb-tip-2">{AvgUploadTPCount}</span>
          份，平均每日有
          <span className="tb-tip-2">{AvgUploadUserCount}</span>人参与制作
        </p>
...
export default connect(mapStateToProps)(memo(forwardRef(TeacherTP)));
